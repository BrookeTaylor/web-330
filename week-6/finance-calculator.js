...
/**
 * Create a variable named currencyFormatter and use JavaScript’s 
 * built-in International Number Formatter.  Set the style to 
 * currency and set the currency to USD.   
 */
